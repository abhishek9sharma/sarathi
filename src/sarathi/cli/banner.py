from sarathi.utils.formatters import format_cyan, format_yellow, format_bold
...
def print_banner():
    ...
    # Line 6:   /((+ )|   |/\_  _/   \
    l6 = format_yellow("       /((+ )|      ") + format_cyan("|/\\_  ") + format_cyan("_/   \\")
    
    # Line 7:      -'    /             S A R A T H I...
    l7 = format_yellow("          -'       ") + format_bold(format_cyan("/               ")) + format_bold(format_cyan("S A R A T H I - Your AI Charioteer"))
